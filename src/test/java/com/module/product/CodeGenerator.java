...
/**
 * Created by 李恒名 on 2017/5/11.
 *
 * 后台代码生成器，根据数据表名称生成对应的Model、Mapper、Service、Controller简化开发。
 *
 */
public abstract class CodeGenerator {
    ...
    private static final String PACKAGE_PATH_SERVICE = "\\com\\service\\";
    private static final String PACKAGE_PATH_SERVICE_IMPL = "\\com\\service\\impl\\";
    private static final String PACKAGE_PATH_CONTROLLER = "\\com\\web\\";
    ...
    public static void genModelAndMapper(String tableName) {
        try {
            ...
            //javaClientGeneratorConfiguration.setTargetPackage("com.ruhang.product.orm.mapper");
